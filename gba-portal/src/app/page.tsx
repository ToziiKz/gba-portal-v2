  ...
  return (
    <div className="min-h-screen bg-[#03040a] text-white">
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-[#03040a]"
        />
        <div
          aria-hidden="true"
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-sm leading-relaxed text-white/65 sm:text-base">
            D’ici, on vise haut. Parce que l’ambition d’un territoire, c’est de
            faire naître l’excellence — dans le jeu, et dans la vie. Un cadre
            exigeant, une famille soudée, et une même direction : progresser, se
            dépasser, et construire quelque chose qui dure.
          </p>
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/60">
              Du premier ballon aux matchs décisifs, chaque joueur avance avec
              un cadre clair : apprendre, progresser, et respecter le jeu. Ici,
              on grandit ensemble — avec exigence, bienveillance, et l’ambition
              de viser plus haut.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-center text-sm text-white/55">
              Dans toutes les catégories, nos équipes évoluent au plus haut
              niveau district.
            </p>
          </div>
        </div>
          ...
          <div className="mb-16 flex flex-col items-center justify-between gap-8 text-center md:flex-row md:text-left">
            <div>
              ...
              <p className="mt-2 text-white/55">
                ...
                Une ambition qui ne lâche rien : faire grandir le club, saison
                après saison.
              </p>
            </div>
            <Link
      ...
      <section id="actu" className="relative overflow-hidden px-6 py-32">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-12 max-w-2xl text-xl leading-relaxed text-white/70">
            Vibrez au bord du terrain, portez nos couleurs, partagez nos
            victoires. Le GBA n&apos;attend que vous.
          </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 text-sm text-white/60 md:grid-cols-4">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="leading-relaxed text-white/50">
              L&apos;esprit d&apos;équipe, la passion du jeu, la force du
              collectif.
            </p>
          </div>
          <div>
            <p className="mb-6 text-xs font-bold uppercase tracking-widest text-white">
              Explorer
            </p>
