...
const quickLinks: QuickLink[] = [
  ...
  {
    label: "Encaissements licences",
    href: "/dashboard/licences",
    kicker: "paiements",
  },
  {
    label: "Remises équipements",
    href: "/dashboard/equipements",
    kicker: "dotations",
  },
  {
    label: "Préparer la semaine",
...
export function DashboardHero() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 opacity-[0.14] hero-grain"
      />
      <div
        aria-hidden="true"
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="min-w-0">
            ...
            <h2 className="mt-4 font-[var(--font-teko)] text-4xl font-black tracking-[0.06em] text-[color:var(--ui-fg)] md:text-5xl">
              Une vue claire.
              <span className="block text-[color:var(--ui-muted)]">
                Des actions immédiates.
              </span>
            </h2>
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[color:var(--ui-muted)]">
              Tout est pensé pour aller vite : repérer l’essentiel, décider,
              exécuter.
            </p>
          </div>
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-2 lg:grid-cols-4">
          {quickLinks.map((link) => (
            ...
            >
              ...
              <p className="mt-3 truncate font-semibold text-[color:var(--ui-fg)]">
                {link.label}
              </p>
