  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
      ...
      <div>
        ...
        <h1
          className={`${teko.className} text-5xl md:text-6xl uppercase text-black mt-2`}
        >
          {title}
        </h1>
      </div>
      ...
      <div className="max-w-md mx-auto p-6 rounded-2xl border border-dashed border-black/10 bg-black/5">
        <p className="text-sm text-slate-400">
          Cette zone du quartier général est en cours de déploiement. Les
          fonctionnalités seront activées prochainement.
        </p>
      </div>
