    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          Mettre en scène l’histoire et la formation avec une narration digne
          d’une campagne, tout en restant concret : infos clés, actus,
          événements, partenaires et boutique.
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          Staff, éducateurs, dirigeants, bénévoles et partenaires. Les
          interfaces sont pensées pour être consultées vite (mobile), sans
          sacrifier le niveau de finition.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          On privilégie la clarté : ce que la plateforme fait (et ne fait pas),
          comment on vous contacte, et où se trouvent les engagements
          essentiels. L’objectif : rassurer sans “blabla”, et faciliter une
          décision.
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-white/70">
          ESPACE GBA est conçu pour le Groupement Bruche Ackerland. Pour une
          démo, un sponsoring ou un accès staff, utilisez la page Contact.
        </p>
